...
export class ComponentNameSearchComponent implements OnInit {
  ...
  message: string="";
  selectedItem: any;
  displayedColumns = ['loinc_Num', 'component','system','class1','long_common_name','radiobutton'];
  ...
  search(term: string, pageNo:any): void {
    ...
    if (term.length > 2) {
      ...
      this.componentMasterServiceService.searchComponent(term, pageNo).subscribe((res:any) => {
