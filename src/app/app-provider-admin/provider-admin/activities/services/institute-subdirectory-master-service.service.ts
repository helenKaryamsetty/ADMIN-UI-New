...
export class InstituteSubDirectoryMasterService {
  ...
  constructor(
    ...
    this.save_InstituteSubDirectory_Url =
      this.admin_Base_Url + 'm/createInstutesubDirectory';
    this.edit_InstituteSubDirectory_Url =
      this.admin_Base_Url + 'm/editInstutesubDirectory';
    this.toggle_activate_InstituteSubDirectory_Url =
      this.admin_Base_Url + 'm/deleteInstutesubDirectory';
