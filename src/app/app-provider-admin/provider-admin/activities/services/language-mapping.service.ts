...
export class LanguageMapping {
  ...
  constructor(
    ...
    this.get_LanguageList_Url =
      this.commonbaseurl + 'beneficiary/getLanguageList';
    this.get_LanguageMappedDetails_Url =
      this.admin_Base_Url + 'getUserMappedLanguage';

    this.get_SaveLanguageMappedDetails_Url =
      this.admin_Base_Url + 'userLanguageMapping';
    this.get_UpdateLanguageMappedDetails_Url =
      this.admin_Base_Url + 'updateUserLanguageMapping';
    this.get_DeleteLanguageMappedDetails_Url =
      this.admin_Base_Url + 'deleteUserLanguageMapping';
  }
