...
export class EmployeeParkingPlaceMappingComponent implements OnInit {
    ...
    getAvailableZones(providerServiceMapID:any) {
        this.employeeParkingPlaceMappingService.getZones({ "providerServiceMapID": providerServiceMapID }).subscribe((response:any) => this.getZonesSuccessHandler(response));
    }
    ...
    getAllParkingPlaces(zoneID: any, providerServiceMapID: any) {
        ...
        this.employeeParkingPlaceMappingService.getParkingPlaces(parkingPlaceObj).subscribe((response:any) => this.getParkingPlaceSuccessHandler(response));
    ...
    getParkingPlaceSuccessHandler(response:any) {
        ...
        if (this.editParkingPlaceValue != undefined) {
            let parkingPlaceUpdate = this.availableParkingPlaces.filter((parkingPlaceResponse: any) => {
    ...
    designations: any;
    getDesignations() {
        this.employeeParkingPlaceMappingService.getDesignations().subscribe((response:any) => this.getDesignationsSuccessHandeler(response));
    }
    ...
    getEmployeeParkingPlaceMappings(searchStateID: any, designationID: any) {
        ...
        this.employeeParkingPlaceMappingService.getEmployees(this.employeeObj).subscribe((response:any) => this.getEmployeeParkingPlaceMappingsSuccessHandler(response));
    }
    ...
    getEmployeeParkingPlaceMappingsSuccessHandler(response:any) {
        ...
        this.filteredavailableEmployeeParkingPlaceMappings.paginator = this.paginator


    }
    parkingPlaceID: any;
    selectedParkingPlace(serviceID: any, parkingPlace: any, providerServiceMapID: any, designationID: any) {
    ...
    getUsernames(providerServiceMapID: any, designationID: any) {
        ...
        this.employeeParkingPlaceMappingService.getUsernames(userObj).subscribe((response:any) => this.getuserNamesSuccessHandeler(response));
    }
    userNames: any = [];
    ...
    getuserNamesSuccessHandeler(response:any) {
        ...
        if (!this.editable) {
            if (this.employeeParkingPlaceMappingList.data.length > 0) {
                this.employeeParkingPlaceMappingList.data.forEach((employeeParkingMap:any) => {
        ...
        if (this.editParkingPlaceValue != undefined) {
            let userNameUpdate = this.userNames.filter((userResponse:any) => {
    ...
    removeRole(rowIndex: any, vanIndex: any) {
        this.employeeParkingPlaceMappingList.data[rowIndex].uservanmapping.splice(vanIndex, 1);
        if (this.employeeParkingPlaceMappingList.data[rowIndex].uservanmapping.length === 0) {
    ...
    saveParkingMpping() {
        let obj = { "userParkingPlaceMaps": this.employeeParkingPlaceMappingList.data };
        this.employeeParkingPlaceMappingService.saveEmployeeParkingPlaceMappings(obj).subscribe((response:any) => this.saveMappingSuccessHandler(response));
    }
    ...
    getMappedVans(userParkingPlaceMapID:any) {
        this.employeeParkingPlaceMappingService.getMappedVansList(userParkingPlaceMapID).subscribe((mappedVanResponse:any) => {
    ...
    patchMappedVans() {
        ...
        this.mappedUserVans.map((mappedVans:any) => {
            let tempData = this.availableVans.filter((filterVan:any) => {
    ...
    filterComponentList(searchTerm?: string) {
        if (!searchTerm) {
            this.filteredavailableEmployeeParkingPlaceMappings.data = this.availableEmployeeParkingPlaceMappings;
        } else {
            this.filteredavailableEmployeeParkingPlaceMappings.data = [];
                ...
                for (let key in item) {
                    if (key == 'userName') {
                        ...
                        if (value.toLowerCase().indexOf(searchTerm.toLowerCase()) >= 0) {
                            this.filteredavailableEmployeeParkingPlaceMappings.data.push(item); break;
                        }
                    }
                }
            });
    ...
    deactivate(userLangID:any) {
        this.alertMessage.confirm('Confirm', "Are you sure you want to Deactivate?").subscribe((response:any) => {
            if (response) {
