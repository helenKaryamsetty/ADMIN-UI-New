...
export class VanSpokeMappingComponent implements OnInit {
  ...
  displayedColumns: string[] = ['SNo', 'ParkingPlace', 'Van','Spoke','action'];
  displayedColumns1: string[] = ['SNo', 'ParkingPlace', 'Van','Spoke','action'];
...
disableServiceline: any;
  ...
  getProviderMappedZones(selectedState:any, booleanValue:any) {
    ...
    this.vanSpokeMappingService.getZones(reqObj).subscribe((zonesResponse:any) => {
      if (this.enabletmSpokeDetailsForm == true && booleanValue == true) {
  ...
  getProviderMappedParkingPlace(selectedZone:any, selectedState: any, booleanValue: any) {
    let reqObj = {
      'zoneID': selectedZone.zoneID,
      'providerServiceMapID': selectedState.providerServiceMapID
    }
    this.vanSpokeMappingService.getParkingPlace(reqObj).subscribe((parkingPlaceResponse:any) => {
      if (this.enabletmSpokeDetailsForm == true && booleanValue == true) {
  ...
  getProviderMappedServicepoint(state: any, parkingplace: any, booleanValue: any) {
    let reqObj = {
      "stateID": state.stateID,
      "parkingPlaceID": parkingplace.parkingPlaceID,
      "serviceProviderID": this._dataService.service_providerID
    }
    this.vanSpokeMappingService.getServicepoints(reqObj).subscribe((servicepointResponse:any) => {
      if (this.enabletmSpokeDetailsForm == true && booleanValue == true) {
  ...
  getProviderMappedVanTypes(state:any, booleanValue:any) {
    ...
    this.vanSpokeMappingService.getVanTypes(reqObj).subscribe((vantypeResponse:any) => {
      if (this.enabletmSpokeDetailsForm == true && booleanValue == true) {
  ...
  getAllVanSpokeMappingData() {
    ...
    this.vanSpokeMappingService.getVanSpokeMapping(fetchObj).subscribe((fetchResponse:any) => {
      this.listVanSpokeMapping = fetchResponse.data.vanSpokeMappedDetails;
      this.filteredListVanSpokeMapping.data = fetchResponse.data.vanSpokeMappedDetails;
  ...
  getProviderMappedVansOrSpokes(state:any, parkingPlace:any, vanType:any, booleanValue:any) {
    let reqObj = {
      'providerServiceMapID': state.providerServiceMapID,
      'parkingPlaceID': parkingPlace.parkingPlaceID,
      'vanTypeID': vanType.vanTypeID
    }
    this.vanSpokeMappingService.getVansOrspoke(reqObj).subscribe((vansResponse:any) => {
      if (this.enabletmSpokeDetailsForm == true && booleanValue == true) {
        ...
        for (let key in item) {
          if (key == 'mmu_vanName' || key == 'tm_spokeName') {
            ...
            if (value.toLowerCase().indexOf(searchTerm.toLowerCase()) >= 0) {
              this.filteredListVanSpokeMapping.data.push(item); break;
            }
          }
        }
      });
  ...
  mappingStatus(mappedVanData:any, activeParkingPlace:any) {
    if (activeParkingPlace) {
      ...
      let returnValue = this.listVanSpokeMapping.filter((filtermappedVan:any) => 
