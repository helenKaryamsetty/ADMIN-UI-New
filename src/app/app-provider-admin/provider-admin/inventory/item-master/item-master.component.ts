...
serviceline: any;
  ...
  getAllItemsList(providerServiceMapID:any) {
    ...
    this.itemService.getAllItems(this.providerServiceMapID).subscribe((itemListResponse:any) =>
        ...
        for (let key in item) {
          if (key == 'itemCode' || key == 'itemName' ) {
            ...
            if (value.toLowerCase().indexOf(searchTerm.toLowerCase()) >= 0) {
              this.filteredItemList.data.push(item); break;
            }
          }
  ...
  setDiscontinue(itemID:any, discontinue:any) {
    ...
    this.itemService.setDiscontinue(itemID, discontinue).subscribe((discontinueResponse:any) => {
  ...
  getCategoriesList(providerServiceMapID:any) {
    this.itemService.getAllItemsCategory(this.providerServiceMapID, 0).subscribe((categoryResponse:any) => {
  ...
  getDosageList(providerServiceMapID:any) {
    this.itemService.getAllDosages(this.providerServiceMapID).subscribe((dosageResponse:any) => {
  ...
  pharmacologiesList(providerServiceMapID:any) {
    ...
    this.itemService.getAllPharmacologyCategory(this.providerServiceMapID).subscribe((pharmacologyResponse:any) => {
  ...
  manufacturerList(providerServiceMapID:any) {
    ...
    this.itemService.getAllManufacturers(this.providerServiceMapID).subscribe((manufacturerResponse:any) => {
  ...
  unitOfMeasuresList(providerServiceMapID:any) {
    ...
    this.itemService.getAllUoms(this.providerServiceMapID).subscribe((uomResponse:any) => {
  ...
  uomSuccesshandler(uomResponse:any) {
    ...
    this.measures = uomResponse.data.filter(
      (      uom: any) => uom.deleted != true
    );
    console.log("measures", this.measures);
  }
  routeAdminList(providerServiceMapID:any) {
    console.log('check inside route');
    this.itemService.getAllRoutes(this.providerServiceMapID).subscribe((routeResponse:any) => {
  ...
  saveItem() {
    this.itemService.createItem(this.itemArrayObj.data).subscribe(response => {
      if (response) {
...
export class EditItemMasterModal {
  ...
  constructor( @Inject(MAT_DIALOG_DATA) public data:any, public dialog: MatDialog,
    public itemService: ItemService,
    public dialogRef: MatDialogRef<EditItemMasterModal>,
    public dialogService: ConfirmationDialogsService) { }
