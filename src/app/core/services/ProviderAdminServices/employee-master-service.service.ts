...
export class EmployeeMasterService {
  ...
  constructor(
    ...
    this.getEmployeeUrl =
      this.providerAdmin_Base_Url + 'm/SearchEmployeeFilter';

    this.getRegistrationDataUrl =
      this.common_Base_Url + 'beneficiary/getRegistrationData';
    this.getAllDistrictsInStateUrl =
      this.common_Base_Url + 'location/districts/';
    this.getAllStatesOfServiceProviderUrl =
      this.providerAdmin_Base_Url + 'm/role/state';
    ...
    this.getAllRolesInServiceLine =
      this.providerAdmin_Base_Url + 'm/role/search';

    this.checkUsernameUrl =
  ...
  getStatesOfServiceProvider(serviceProviderID: any) {
  ...
  getServicesOfServiceProvider(serviceProviderID: any, stateID: any) {
  ...
  getRolesInServiceLine(serviceProviderID: any, stateID: any, serviceID: any) {
  ...
  getRoles(serviceProviderID: any, stateID: any, serviceID: any) {
  ...
  // CRUD begins
  createEmployee(requestObject: any) {
  ...
  editEmployee(requestObject: any) {
    return this.http.post(this.editEmployeeUrl, requestObject);
    // .map(this.handleSuccess)
    // .catch(this.handleError);
  }

  deleteEmployeeRole(usrMapID: any) {
