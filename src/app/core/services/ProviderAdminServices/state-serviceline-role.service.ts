...
export class ProviderAdminRoleService {
  ...
  constructor(
    ...
    this.find_Roles_By_State_Service_Url =
      this.admin_Base_Url + 'm/role/search';
  ...
  getRoles(obj: any) {
    return this.http.post(this.find_Roles_By_State_Service_Url, obj);
  ...
  deleteRole(obj: any) {
    ...
    return this.http.post(this.delete_Role_Url, obj);
    // .map(this.handleSuccess)
    // .catch(this.handleError);
  }
  ...
  updateFeatureToRole(requestArray: any) {
    return this.http.post(this.updateFeatureToRole_Url, requestArray);
    // .map(this.handleSuccess)
    // .catch(this.handleError);
  }
