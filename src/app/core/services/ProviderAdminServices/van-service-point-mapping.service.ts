...
export class VanServicePointMappingService {
  ...
  constructor(
    ...
    this.saveVanServicePointMappingsURL =
      this.providerAdmin_Base_Url + 'vanMaster/save/vanServicePointMappings';
    this.getVanServicePointMappingsURL =
      this.providerAdmin_Base_Url + 'vanMaster/get/vanServicePointMappingsV1';
    this.updateVanServicePointMappingsURL =
      this.providerAdmin_Base_Url + 'vanMaster/remove/vanServicePointMapping';
    this.getVanTypesURL =
