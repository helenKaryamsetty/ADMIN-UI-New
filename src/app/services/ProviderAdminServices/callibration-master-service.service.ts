...
export class CallibrationMasterServiceService {
  ...
  fetCalibrationMasters(obj) {
    return this.http
      .post(this.getCalibrationMaster_Url, obj)
  ...
  deleteCalibrationStrip(obj) {
    ...
    return this.http
      .post(this.delete_CalibrationStrip_Url, obj)
      .map(this.handleSuccess)
      .catch(this.handleError);
  }
  createCalibrationStrip(calibrationObj) {
    return this.http
      .post(this.save_Calibration_Url, calibrationObj)
      .map(this.handleSuccess)
      .catch(this.handleError);
  }
  ...
  updateCalibrationStrip(calibrationObj) {
    return this.http
      .post(this.update_Calibration_Url, calibrationObj)
      .map(this.handleSuccess)
      .catch(this.handleError);
  }
  ...
  handleSuccess(response: Response) {
    console.log(
      response.json().data,
      'Calibration Strip save_update success response',
    );
    const result = [];
    if (response.json()) {
