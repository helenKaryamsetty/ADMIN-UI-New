...
export class BlockProvider {
  ...
  constructor(
    ...
    this.getAllServicesInStateOfProvider_Url =
      this.admin_base_url + 'm/role/service';

    this.getAllServicesOfProvider_Url =
      this.admin_base_url + 'getServiceLinesUsingProvider';
    this.getAllServicesOfProvider_CTI_Url =
      this.admin_base_url + 'm/role/serviceNew';

    // get status of blocked/unblocked
    this.getProviderLevelStatus_Url =
      this.admin_base_url + 'getProviderStatus1';
    this.getProvider_StateLevelStatus_Url =
      this.admin_base_url + 'getProviderStatusByState';
    this.getProvider_ServiceLineLevelStatus_Url =
      this.admin_base_url + 'getProviderStatusByProviderAndServiceId';
    this.getProvider_State_ServiceLineLevelStatus_Url =
      this.admin_base_url + 'getProviderStatusByService';
    ...
    this.block_unblock_serviceline_url =
      this.admin_base_url + 'blockProviderByServiceId';
    this.block_unblock_serviceOfState_url =
      this.admin_base_url + 'blockProviderByService';
  ...
  getAllSubService(serviceID) {
    return this._http
      .post(this.getAllSubService_URL, { serviceID: serviceID })
      .map(this.success_handeler)
      .catch(this.error_handeler);
  }
  getStates(serviceProviderID) {
    return this._http
      .post(this.getAllStatesOfProvider_Url, {
  ...
  getServicesInState(serviceProviderID, stateID) {
    return this._http
      .post(this.getAllServicesInStateOfProvider_Url, {
        serviceProviderID: serviceProviderID,
        stateID: stateID,
      })
      .map(this.handleState_n_ServiceSuccess)
  ...
  getStatesInServices(data) {
    return this._http
      .post(this.getProvider_ServiceLineLevelStatus_Url, data)
      .map(this.handleState_n_ServiceSuccess)
      .catch(this.error_handeler);
  }
  ...
  getServicesOfProvider(serviceProviderID) {
    return this._http
      .post(this.getAllServicesOfProvider_Url, {
        serviceProviderID: serviceProviderID,
      })
      .map(this.success_handeler)
      .catch(this.error_handeler);
  ...
  getServicesOfProvider_CTI(userID) {
    return this._http
      .post(this.getAllServicesOfProvider_CTI_Url, {
        userID: userID,
      })
      .map(this.success_handeler)
      .catch(this.error_handeler);
  ...
  getProviderLevelStatus(serviceProviderID) {
    return this.httpInterceptor
      .post(this.getProviderLevelStatus_Url, {
        serviceProviderID: serviceProviderID,
      })
      .map(this.success_handeler)
      .catch(this.error_handeler);
  ...
  getProvider_StateLevelStatus(serviceProviderID, stateID) {
    return this.httpInterceptor
      .post(this.getProvider_StateLevelStatus_Url, {
        serviceProviderID: serviceProviderID,
        stateID: stateID,
      })
      .map(this.success_handeler)
  ...
  getProvider_ServiceLineLevelStatus(serviceProviderID, serviceID) {
    return this.httpInterceptor
      .post(this.getProvider_ServiceLineLevelStatus_Url, {
        serviceProviderID: serviceProviderID,
        serviceID: serviceID,
      })
      .map(this.success_handeler)
  ...
  getProvider_State_ServiceLineLevelStatus(
    ...
    return this.httpInterceptor
      .post(this.getProvider_State_ServiceLineLevelStatus_Url, {
        serviceProviderID: serviceProviderID,
        stateID: stateID,
        serviceID: serviceID,
      })
  ...
  block_unblock_provider(serviceProviderID, statusID, reason) {
    return this.httpInterceptor
      .post(this.block_unblock_provider_url, {
        serviceProviderID: serviceProviderID,
        statusID: statusID,
        reason: reason,
      })
  ...
  block_unblock_state(serviceProviderID, stateID, statusID, reason) {
    return this.httpInterceptor
      .post(this.block_unblock_state_url, {
        serviceProviderID: serviceProviderID,
  ...
  block_unblock_serviceline(serviceProviderID, serviceID, statusID, reason) {
    return this.httpInterceptor
      .post(this.block_unblock_serviceline_url, {
        serviceProviderID: serviceProviderID,
        statusID: statusID,
        serviceID: serviceID,
        reason: reason,
  ...
  block_unblock_serviceOfState(
    ...
    return this.httpInterceptor
      .post(this.block_unblock_serviceOfState_url, {
        serviceProviderID: serviceProviderID,
        statusID: statusID,
        stateID: stateID,
        serviceID: serviceID,
  ...
  deleteSubService(obj) {
    return this.httpInterceptor
      .post(this.deleteSubserviceUrl, obj)
      .map(this.success_handeler)
      .catch(this.error_handeler);
  }
  editProvider(serviceProviderObj: any) {
    return this.httpInterceptor
      .post(this.editProvider_URL, serviceProviderObj)
      .map(this.success_handeler)
      .catch(this.error_handeler);
  }
