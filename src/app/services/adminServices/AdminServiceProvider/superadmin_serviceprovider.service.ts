...
//       .post(this.getServicelinesFromProvider_url, {
...
//     return this._httpInterceptor
//       .post(this.getAllStatesByProviderUrl, {
//         serviceProviderID: serviceProviderID,
...
//     return this._httpInterceptor
//       .post(this.getAllServicesByProviderUrl, {
//         serviceProviderID: serviceProviderID,
//       })
//       .map(this.extractData)
//       .catch(this.handleError);
...
//     return this._httpInterceptor
//       .post(this.getAllServiceLinesByProviderUrl, {
//         serviceProviderID: serviceProviderID,
//         stateID: stateID,
//       })
//       .map(this.extractData)
