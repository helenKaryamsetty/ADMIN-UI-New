...
export const environment = {
  ...
  saveZoneDistrictMappingURL :
    `${adminBaseUrl}zonemaster/save/zoneDistrictMapping`,
  getZoneDistrictMappingURL :
    `${adminBaseUrl}zonemaster/get/zoneDistrictMappings`,

  updateZOneStatusURL :
    `${adminBaseUrl}zonemaster/remove/zone`,
  updateZOneDistrictMappingURL :
    `${adminBaseUrl}zonemaster/remove/zoneDistrictMapping`,

  updateZoneDataURL :
    `${adminBaseUrl}zonemaster/update/zoneData`,

  _getStateListByServiceIDURL :
    `${adminBaseUrl}m/location/getStatesByServiceID`,
  ...
  getServiceLinesZone_new_url :
    `${adminBaseUrl}m/role/serviceNew`,
  getStateszone_new_url : `${adminBaseUrl}m/role/stateNew`,
  updateZoneMappingDataUrl :
    `${adminBaseUrl}/zonemaster/edit/zoneDistrictMapping`,

    _postProcedureURL :
    `${adminBaseUrl}labModule/createProcedureMaster`,
  _getProcedureListURL :
    `${adminBaseUrl}labModule/fetchProcedureMaster/`,
  _toggleProcedureURL :
    `${adminBaseUrl}labModule/updateProcedureStatus`,
  _updateProcedureURL :
    `${adminBaseUrl}labModule/updateProcedureMaster`,
  _iotProcedureURL :
    `${adminBaseUrl}diagnostics/getDiagnosticProcedure`,
